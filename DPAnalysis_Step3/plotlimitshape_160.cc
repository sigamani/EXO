...
void plot_limit_mass(std::string LAMBDA){
  ...
  //Real CTAU
  Double_t mTh[6] = {0.0428,0.428,4.28,21.4,42.8,85.6};
  Double_t x_pdf[12] = {0.0428,0.428,4.28,21.4,42.8,85.6,85.6,42.8,21.4,4.28,0.428,0.0428};
  ...
  c0->SaveAs("exclusion_limit_L160"+extra+".png");
