...
void plot_limit_mass(std::string LAMBDA){
  ...
  obs_lim[2] = xsec*CT50histo1->GetMean();
  obs_lim[3] = xsec*CT250histo1->GetMean();
  ...
  //Double_t x_pdf[12] = {0.1,1.0,5.0,25.0,50.0,200.0,200.0,50.0,25.0,5.0,1.0,0.1}; 

  //Real CTAU
  Double_t mTh[6] = {0.0366,0.366,1.83,9.14,18.3,73.1};
  Double_t x_pdf[12] = {0.0366,0.366,1.83,9.14,18.3,73.1,73.1,18.3,9.14,1.83,0.366,0.0366};
  ...
  exp_lim_graph->GetXaxis()->SetRangeUser(0.001, 9000.);
  ...
  c0->SaveAs("exclusion_limit_L180"+extra+".png");
